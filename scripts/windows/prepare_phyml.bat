...
set getdown_txt_source=%PHYML_GRID_HOME%\resources\getdown.txt
...
set nesi_png=%dir%\nesi.png
set nesi_png_source=%PHYML_GRID_HOME%\resources\nesi.png
...
if NOT EXIST %java_vm_location% (
	set JAVA_EXE="%PHYML_GRID_HOME%\java_vm\bin\java.exe"
) else (
